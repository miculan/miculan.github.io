...
And using categorical tools in {%cite bm:ictcs16%}{%cite DBLP:journals/tcs/BernardoM19%} we established a surprising result: disjunctive probabilistic modal logic is enough to fully characterize bisimilarity on reactive probabilistic systems (also known as Markov decision processes).
