...
Utilizing the [ProVerif](https://bblanche.gitlabpages.inria.fr/proverif/) tool (which adopts the applied π-calculus for representing cryptographic protocols), we have investigated the security of Telegram's MTProto 2.0 protocol {%cite mv:secrypt21 %}{%cite MICULAN2022103072 %} and the Multi-Factor Authentication of Italian e-IDAS digital identity card CIE {%cite vepm:secrypt24%}{%cite pvem:sefm24%}. 
