...
## Research history
It is difficult to summarise over three decades of research in a single page, so I will recall some few achievements. Overall, I can say that my research has consistently focused on developing and applying formal methods to model and understand complex systems, in order to enhance their trustworthiness. Along all these years, my interests have evolved within this broad landscape, tackling new challenges as they emerged.
