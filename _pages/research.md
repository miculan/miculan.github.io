...
To this end, we introduced _AbU_, a calculus for modeling and reasoning about Event-Condition-Action (ECA) systems with _attribute-based communication_ {%cite mp:ictac21 PASQUA2023113841%}. This communication model facilitates coordination among large node families in a declarative manner.
